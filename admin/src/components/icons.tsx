...
export function RefundIcon({ color = 'currentColor', size = 19 }: { color?: string; size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M4 12a8 8 0 1 1 2.5 5.8" stroke={color} strokeWidth="1.9" strokeLinecap="round" />
      <path d="M4 7.5V12h4.5" stroke={color} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
